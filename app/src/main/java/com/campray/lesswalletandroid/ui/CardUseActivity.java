...
public class CardUseActivity extends MenuActivity {
    ...
    private void loadData(long couponId){
        ...
        tv_navi_title.setText(coupon.getProduct().getTitle());
        ...
        tv_point.setText(LessWalletApplication.INSTANCE().getAccount().getPoints()+"");
        ...
        try {
            Bitmap qrCodeBitmap=QRCodeEncoder.encodeAsBitmap("Card:"+coupon.getOrderId(), BarcodeFormat.QR_CODE,200);
