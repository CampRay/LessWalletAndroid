...
/**
 * 日期时间工具类，里面包含了 DatePickerDialog 和 TimePickerDialog 的简单使用， 可自定义设置背景， 标题， 不显示年或日等
 * Created by Phills on 8/10/2018.
 */

public class BasicTimesUtils {
     ...
     */
    public static BasicTimesUtils showDatePickerDialog(Context context, boolean themeLight, String title, int year, int month, int day, OnDatePickerListener onDateTimePickerListener) {
     ...
     * 显示日期选择器, 默认白色背景
     */
    public static BasicTimesUtils showDatePickerDialog(Context context, String title, int year, int month, int day, OnDatePickerListener onDateTimePickerListener) {
     ...
     * 显示日期选择器
     */
    public static BasicTimesUtils showDatePickerDialog(Context context, int themeId, String title, int year, int month, int day,
